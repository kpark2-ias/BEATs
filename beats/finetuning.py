...
#             model_name = 'models/fine-tuned-cpt2/BEATs_iter3_plus_AS2M_finetuned_on_AS2M_cpt2.pt'
#             model_checkpoint = torch.load(pretrained_model, map_location='cuda')
#             cfg = BEATsConfig(model_checkpoint['cfg'])
